...
const Fotter = () => {
  return (
    <div className='w-full justify-between flex gap-5 h-screen bg-zinc-900 p-20 font-FoundersGrotest'>
        <div className='w-1/2 h-full justify-between flex-col flex '>
        ...
        <div className='w-1/2 '>
        <h1 className='text-[7vw] uppercase leading-none -mb-10 '>
            PRESENTATIONS
            </h1>
            <div className='dets font-["Neue_Montreal"] mt-20 '>
                <h1 className='my-4 uppercase text-2xl'>S :</h1>
                <a  className='block no-underline md:underline   font-light text-xl' href="#">Facebook</a>
                <a className='block  no-underline md:underline  font-light text-xl'  href="#">Instagram</a>
                <a  className='block no-underline md:underline   font-light text-xl' href="#">Behance</a>
                <a  className='block no-underline md:underline   font-light text-xl' href="#">LInkedin</a>
            </div>
            <div className='dets font-["Neue_Montreal"] mt-10 '>
                <h1 className='my-4 uppercase text-2xl'>L :</h1>
                <div className='mb-10'>
                <a  className='block no-underline md:underline   font-light text-xl' href="#">202-1965 W 4th Ave</a>
                <a className='block  no-underline md:underline  font-light text-xl'  href="#">Vancouver, Canada</a>
                </div>
                <a  className='block no-underline md:underline   font-light text-xl' href="#">30 Chukarina St</a>
                <a className='block  no-underline md:underline  font-light text-xl'  href="#">Lviv, Ukraine</a>
            </div>
            <div className='dets font-["Neue_Montreal"] mt-10 '>
                <h1 className='my-4 uppercase text-2xl'>E :</h1>
                <a  className='block no-underline md:underline   font-light text-xl' href="#">hello@ochi.design</a>
            </div>
        </div>
